...
MySQL - 5.5.5-10.1.22-MariaDB : Database - agencia_viajes
*********************************************************************
*/
...
insert  into `tblclientes`(`intIdCliente`,`vchNombre`,`vchApellidos`,`vchDireccion`,`vchTelefono`,`vchEmail`,`intIdSucursal`) values (1,'Abiram','Hernández Hernández','Huitzitzilingo','7711153228','arm.1012@gmail.com',2);
...
insert  into `tblempleados`(`intIdEmpleado`,`vchNombre`,`vchApellidos`,`vchDireccion`,`vchTelefono`,`intIdSucursal`) values (1,'Sergio','Hernández Vite','Huextetitla','7711167127',1),(2,'fabian','santiago hernandez','acuatempa','7713468210',1);
...
CREATE TABLE `tbleventos` (
  ...
  `vchFecha` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`intIdEvento`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `tbleventos` */

insert  into `tbleventos`(`intIdEvento`,`vchNombre`,`vchDescripcion`,`vchDireccion`,`vchFecha`) values (1,'xantolo','je','je','sábado, 28 de octubre de 2017');
...
insert  into `tbllugares`(`intIdLugar`,`vchNombre`,`vchDireccion`,`vchDescripcion`) values (1,'Canadá','canadá lugar bonito','lugar turísticos de la ciudad de Estados Unidos de America');
...
insert  into `tblsucursales`(`intIdSucursal`,`vchNombre`,`vchEncargado`,`vchDireccion`,`vchTelefono`,`intIdAgencia`) values (1,'Huejutla','Fabian Santiago Hernández','Acuatempa','9839574633',1),(2,'Agencia Huitzi','Sergio Hernández Vite','Huitzisilingo','8819382981',1);
